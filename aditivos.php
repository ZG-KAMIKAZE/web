...
<footer class="text-center footer-style">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-3 footer-col">
                <h3>Social</h3>
                <p><a href="#" class="social-icon"><i class="fa fa-facebook"></i></a>
                <a href="#" class="social-icon"><i class="fa fa-twitter"></i></a>
                <a href="#" class="social-icon"><i class="fa fa-instagram"></i></a></p>
            </div>
            <div class="col-md-3 footer-col">
...
$(document).ready(function() {
    $('#productoModal').on('show.bs.modal', function(event) {
        ...
        var stockAlert = modal.find('#stock-alert');

        // Resetea la alerta
        stockAlert.addClass('d-none');

        modal.find('#btn-mas').off().on('click', function() {
        ...
        modal.find('#btn-menos').off().on('click', function() {
            var cantidad = parseInt(cantidadInput.val());
            if (cantidad > 1) {
                cantidadInput.val(cantidad - 1);
            }
        ...
        cantidadInput.on('input', function() {
            ...
            modal.find('#modal-cantidad').val(cantidad);
        });
    });
});
</script>
