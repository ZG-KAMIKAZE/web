...
// Obtener productos de la categoría "Baños" con el filtro de orden y búsqueda
$categoria_id = 2; // Cambiar el ID de la categoría a 2 (para "Baños")
...
<head>
    ...
    <title>Baños - Sistema de Ventas Ferretería Clavijo</title>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            ...
                            <li class="divider"></li>
                            <li><a href="banos.php" target="principal">BAÑOS</a></li>
                            <li class="divider"></li>
...
<footer class="text-center footer-style">
    <div class="container">
        ...
        <p>&copy; 2023 FERRTERIA CLAVIJO. Todos los derechos reservados.</p>
    </div>
</footer>
